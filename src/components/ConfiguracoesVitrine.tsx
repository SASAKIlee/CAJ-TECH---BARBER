...
export default function ConfiguracoesVitrine() {
  ...
  const handleSalvar = async () => {
    if (!config.id) return toast.error("Erro ao identificar barbearia.");
    ...
    <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 max-w-6xl mx-auto">
      ...
      <Card className="lg:col-span-3 p-6 bg-zinc-900 border-zinc-800 text-white shadow-2xl rounded-[24px]">
        ...
        <div className="space-y-6">
          ...
          <Button 
            className="w-full h-16 font-black uppercase tracking-widest text-black mt-6 rounded-2xl transition-all active:scale-95 shadow-xl"
            style={{ 
      ...
      {/* COLUNA DE PREVIEW (2/5) - 🚀 O GRANDE UPGRADE */}
        ...
        <div className="relative mx-auto w-full max-w-[280px] aspect-[9/18] bg-zinc-950 rounded-[3rem] border-[8px] border-zinc-800 shadow-2xl overflow-hidden flex flex-col">
           ...
           <div className="relative flex-1 flex flex-col">
              ...
              <div className="absolute inset-0 z-0">
                 {config.url_fundo ? (
                    <img src={config.url_fundo} className="h-full w-full object-cover" alt="bg" />
                 ) : (
